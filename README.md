...
- TomoTalk (Japanese Alphabet Learning Application)
  - [Web application with Authentication, authorization, database, Vue Frontend, Java Spring Boot Backend, JPA Entities](https://onevistastudio.com/building-a-study-automation-platform/](https://japanese-character-learner.thankfulhill-561db2f1.westus2.azurecontainerapps.io/))
